...
├── customer_data.csv       # Real customer dataset
...
### Data Updates
- Replace `customer_data.csv` in the project root when using real data
- Update files in `data/` for sample-based testing
